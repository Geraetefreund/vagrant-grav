...
isgrmlcd && HISTSIZE=500  || HISTSIZE=10000
...
# End:
cd /vagrant/
#PROMPT="%{$fg[blue]%}(GRAV) %{$fg_bold[red]%}%n%{$fg_no_bold[white]%}$"
PROMPT="%{$fg[blue]%}(GRAV) %{$fg_bold[red]%}%n%{$fg_no_bold[white]%}@%m %40<...<%B%~%b%<< %\# "
